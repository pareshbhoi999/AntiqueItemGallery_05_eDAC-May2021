...
<div class="container-fluid" style="background:  #fdedff">
    ...
    <p>Name : <strong>${o.customer.fname } </strong></p>
     <p>Address : <strong> ${o.customer.lname }</strong></p>
            ...
            <div class='p-3 rounded bg-white'>
                <c:forEach items="${items }" var="item">
	                <div class="border-bottom pb-3">
	                    ...
	                    <div class="p-2">
	                        <h6>Name : ${item.product.pname }</h6>
	                        <h6>Description : ${item.product.company }</h6>
	                        <h6>${item.product.salt }</h6>
